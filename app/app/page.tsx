          ...
          <div className="max-w-3xl mx-auto">
            <div className="flex flex-col items-center">
              <div className="mt-2 flex flex-col md:flex-row items-center justify-center gap-4">
                ...
                <button
                  disabled
                  className="h-14 rounded-lg bg-white text-gray-900 border border-gray-200 cursor-not-allowed flex items-center justify-center gap-3 px-6 hover:bg-gray-100 hover:border-gray-300 hover:shadow-md transition-all duration-200 w-auto"
                >
                  ...
                  <span className="text-sm md:text-base">App Store (Coming soon)</span>
                </button>
                {/* Google Play */}
                <a
                  href={playUrl}
