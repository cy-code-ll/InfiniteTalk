...
export function SectionHeading({ title, kicker, icon }: { title: string; kicker?: string; icon?: React.ReactNode }) {
  return (
    <div className="mb-12">
      {kicker && (
...
export function GlowCard({ children, className = '', padding = 'p-6', innerClassName = '' }: React.PropsWithChildren<{ className?: string; padding?: string; innerClassName?: string }>) {
  return (
