              ...
              <div className="flex items-center gap-2 justify-around">
                {selectedTemplateId && selectedMusicId && (
                  <div className="flex items-center gap-2">
                    <Button
                      variant="outline"
                      className="border-2 border-yellow-400/50 bg-black text-white hover:bg-gray-900 hover:border-yellow-400 h-10 px-3 rounded-lg shadow-lg flex items-center gap-1.5"
                      onClick={() =>
                    ...
                    <Button
                      ...
                      className="border-2 border-yellow-400/50 bg-gradient-to-r from-red-600 to-red-700 text-yellow-300 hover:from-red-700 hover:to-red-800 hover:border-yellow-400 disabled:opacity-50 disabled:cursor-not-allowed w-10 h-10 rounded-lg shadow-lg flex items-center justify-center"
