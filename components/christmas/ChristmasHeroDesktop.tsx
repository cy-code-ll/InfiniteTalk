...
const sampleVideos = [
  ...
  {
    id: 2,
    src: 'https://static.infinitetalk2.com/infinitetalk/h1.mp4',
    videoPoster: 'https://static.infinitetalk2.com/infinitetalk/h1.webp',
    poster: '/video/christmas/santa-reading.webp',
  },
  {
    id: 1,
    src: 'https://static.infinitetalk2.com/infinitetalk/h2.mp4',
    videoPoster: 'https://static.infinitetalk2.com/infinitetalk/h2.webp',
    poster: '/video/christmas/santa-decorating.webp',
  },
  {
    id: 3,
    src: 'https://static.infinitetalk2.com/infinitetalk/h3.mp4',
    videoPoster: 'https://static.infinitetalk2.com/infinitetalk/h3.webp',
...
const TEMPLATES = [
  {
    ...
    previewVideo: 'https://static.infinitetalk2.com/infinitetalk/t1.mp4',
    videoPoster: 'https://static.infinitetalk2.com/infinitetalk/t1.webp',
    previewVideomobile: 'https://static.infinitetalk2.com/infinitetalk/t1-m.mp4',
    videoPostermobile: 'https://static.infinitetalk2.com/infinitetalk/t1-m.webp',
    prompt:
  ...
  },
  {
    ...
    previewVideo: 'https://static.infinitetalk2.com/infinitetalk/t2.mp4',
    videoPoster: 'https://static.infinitetalk2.com/infinitetalk/t2.webp',
    previewVideomobile: 'https://static.infinitetalk2.com/infinitetalk/t2-m.mp4',
    videoPostermobile: 'https://static.infinitetalk2.com/infinitetalk/t2-m.webp',
    prompt:
  ...
  },
  {
    ...
    previewVideo: 'https://static.infinitetalk2.com/infinitetalk/t3.mp4',
    videoPoster: 'https://static.infinitetalk2.com/infinitetalk/t3.webp',
    previewVideomobile: 'https://static.infinitetalk2.com/infinitetalk/t3-m.mp4',
    videoPostermobile: 'https://static.infinitetalk2.com/infinitetalk/t3-m.webp',
    prompt:
  ...
  },
  {
    ...
    previewVideo: 'https://static.infinitetalk2.com/infinitetalk/t4.mp4',
    videoPoster: 'https://static.infinitetalk2.com/infinitetalk/t4.webp',
    previewVideomobile: 'https://static.infinitetalk2.com/infinitetalk/t4-m.mp4',
    videoPostermobile: 'https://static.infinitetalk2.com/infinitetalk/t4-m.webp',
    prompt:
  ...
  },
  {
    ...
    previewVideo: 'https://static.infinitetalk2.com/infinitetalk/infinitetalk_5_pc.mp4',
    videoPoster: 'https://static.infinitetalk2.com/infinitetalk/5_pc.webp',
    previewVideomobile: 'https://static.infinitetalk2.com/infinitetalk/infinitetalk_5_m.mp4',
...
export function ChristmasHeroDesktop() {
  ...
  const renderBackground = () => (
    <div 
      ...
      style={{
        backgroundImage: 'url(https://static.infinitetalk2.com/infinitetalk/bg03.jpg)',
  ...
  const renderDisplay = () => (
      <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden font-mountains">
      {renderBackground()}
      {/* 整个组件的下雪效果 */}
